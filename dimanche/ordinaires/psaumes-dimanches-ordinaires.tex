...
\small
  ...
  \begin{footnotesize}
    \textit{
      \textcolor{red}{2. }Jusqu'à ce que je mette tes ennemis pour le marchepied de tes pieds. \textcolor{red}{3. }L'Éternel enverra de Sion la verge de ta force: Domine au milieu de tes ennemis! \textcolor{red}{4. }Ton peuple sera un peuple de franche volonté, au jour de ta puissance, en sainte magnificence. Du sein de l'aurore te viendra la rosée de ta jeunesse. \textcolor{red}{5. }L'Éternel a juré, et il ne se repentira point: Tu es sacrificateur pour toujours, selon l'ordre de Melchisédec. \textcolor{red}{6. }Le Seigneur, à ta droite, brisera les rois au jour de sa colère. \textcolor{red}{7. }Il jugera parmi les nations, il remplira tout de corps morts, il brisera le chef d'un grand pays. \textcolor{red}{8. }Il boira du torrent dans le chemin, c'est pourquoi il lèvera haut la tête.
    }
  \end{footnotesize}
  ...
  \begin{footnotesize}
    \textit{
      \textcolor{red}{1. }De tout cœur je rendrai grâce au Seigneur dans l'assemblée, parmi les justes.
      \textcolor{red}{2. }Grandes sont les œuvres du Seigneur ; tous ceux qui les aiment s'en instruisent. \textcolor{red}{3. }Noblesse et beauté dans ses actions : à jamais se maintiendra sa justice. \textcolor{red}{4. }De ses merveilles il a laissé un mémorial ; le Seigneur est tendresse et pitié, il a donné des vivres à ses fidèles, \textcolor{red}{5. }Gardant toujours mémoire de son
      alliance, il a montré sa force à son peuple. \textcolor{red}{6. }Lui donnant le domaine des nations. Justesse et sûreté les œuvres de ses mains. \textcolor{red}{7. }Sécurité, toutes ses lois, établies pour toujours et à jamais, accomplies avec droiture et sûreté ! \textcolor{red}{8. }Il apporte la délivrance à son peuple ; son alliance est promulguée pour toujours. \textcolor{red}{9. }Saint, redoutable est son nom, la sagesse commence avec la crainte du Seigneur. \textcolor{red}{10. }Qui accomplit sa volonté en est éclairé. A jamais se maintiendra sa louange.
    }
  \end{footnotesize}
  ...
  \begin{footnotesize}
    \textit{
      \textcolor{red}{1. }Heureux l’homme qui craint le Seigneur, qui aime entièrement sa volonté !
      \textcolor{red}{2. }Sa lignée sera puissante sur la terre ; la
      race des justes est bénie.
      \textcolor{red}{3. }Les richesses affluent dans sa maison : à
      jamais se maintiendra sa justice.
      \textcolor{red}{4. }Lumière des cœurs droits, il s'est levé
      dans les ténèbres, l’homme de justice, de
      tendresse et de pitié.
      \textcolor{red}{5. }L'homme de bien a pitié, il partage ; il
      mène ses affaires avec droiture, cet
      homme jamais ne tombera ;
      \textcolor{red}{6. }Toujours on fera mémoire du juste, il ne
      craint pas l'annonce d'un malheur :
      \textcolor{red}{7. }Le cœur ferme, il s'appuie sur le
      Seigneur. Son cœur est confiant, il ne
      craint pas : il verra ce que valaient ses
      oppresseurs.
      \textcolor{red}{8. }A pleines mains, il donne au pauvre ; à
      jamais se maintiendra sa justice, sa
      puissance grandira, et sa gloire !
      \textcolor{red}{9. }L'impie le voit et s'irrite ; il grince des
  ...
  \begin{footnotesize}
    \textit{
      \textcolor{red}{1. }Louez, serviteurs du Seigneur, louez le nom du Seigneur !
      \textcolor{red}{2. }Béni soit le nom du Seigneur, maintenant et
      pour les siècles des siècles !
      \textcolor{red}{3. }Du levant au couchant du soleil, loué soit le
      nom du Seigneur !
      \textcolor{red}{4. }Le Seigneur domine tous les peuples, sa gloire
      domine les cieux.
      \textcolor{red}{5. }Qui est semblable au Seigneur notre Dieu ?
      Lui, il siège là-haut, mais il abaisse son regard vers le ciel et vers la terre.
      \textcolor{red}{6. }De la poussière il relève le faible, il retire le
      pauvre de la cendre
      \textcolor{red}{7. }Pour qu'il siège parmi les princes, parmi les
      princes de son peuple.
      \textcolor{red}{8. }Il installe en sa maison la femme stérile,
  ...
  \begin{footnotesize}
    \textit{
      \textcolor{red}{1. }Quand Israël sortit d'Égypte, et Jacob, de chez un peuple étranger,
      \textcolor{red}{2. }Juda fut pour Dieu un sanctuaire, Israël
      devint son domaine.
      \textcolor{red}{3. }La mer voit et s'enfuit, le Jourdain retourne
      en arrière.
      \textcolor{red}{4. }Comme des béliers, bondissent les montagnes,
      et les collines, comme des agneaux.
      \textcolor{red}{5. }Qu'as-tu, mer, à t'enfuir, Jourdain, à
      retourner en arrière ?
      \textcolor{red}{6. }Montagnes, pourquoi bondir comme des
      béliers, collines, comme des agneaux ?
      \textcolor{red}{7. }Tremble, terre, devant le Maître, devant la
      face du Dieu de Jacob,
      \textcolor{red}{8. }Lui qui change le rocher en source et la pierre
      en fontaine d’eau vive.
      \textcolor{red}{9. }Non pas à nous, Seigneur, non pas à nous,
      mais à ton nom donne la gloire.
      \textcolor{red}{10. }Pour ton amour et ta vérité.
      \textcolor{red}{11. }Pourquoi les païens diraient-ils : « Où donc
      est leur Dieu ? »
      \textcolor{red}{12. }Notre Dieu, il est au ciel ; tout ce qu'il veut,
      il le fait.
      \textcolor{red}{13. }Leurs idoles : or et argent, ouvrages de mains
      humaines.
      \textcolor{red}{14. }Elles ont une bouche et ne parlent pas, des
      yeux et ne voient pas,
      \textcolor{red}{15. }Des oreilles et n'entendent pas, des narines et
      ne sentent pas.
      \textcolor{red}{16. }Leurs mains ne peuvent toucher, leurs pieds
      ne peuvent marcher, pas un son ne sort de
      leur gosier !
      \textcolor{red}{17. }Qu'ils deviennent comme elles, tous ceux qui
      les font, ceux qui mettent leur foi en elles.
      \textcolor{red}{18. }Israël, mets ta foi dans le Seigneur : le
      secours, le bouclier, c'est lui !
      \textcolor{red}{19. }Famille d'Aaron, mets ta foi dans le
      Seigneur : le secours, le bouclier, c'est lui !
      \textcolor{red}{20. }Vous qui le craignez, ayez foi dans le
      Seigneur : le secours, le bouclier, c'est lui !
      \textcolor{red}{21. }Le Seigneur se souvient de nous : il bénira !
      Il bénira la famille d'Israël, et la famille
      d'Aaron
      \textcolor{red}{22. }Il bénira tous ceux qui craignent le Seigneur,
      du plus grand au plus petit.
      \textcolor{red}{23. }Que le Seigneur multiplie ses bienfaits pour
      vous et vos enfants !
      \textcolor{red}{24. }Soyez bénis par le Seigneur qui a fait le ciel
      et la terre !
      \textcolor{red}{25. }Le ciel, c'est le ciel du Seigneur ; aux
      hommes, il a donné la terre.
      \textcolor{red}{26. }Les morts ne louent pas le Seigneur, ni ceux
      qui descendent au silence.
      \textcolor{red}{27. }Nous, les vivants, bénissons le Seigneur,
