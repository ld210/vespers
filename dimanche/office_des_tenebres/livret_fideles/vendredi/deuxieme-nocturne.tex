...
\begin{document}
  ...
  \bigskip
    ...
    \begin{enumerate}[label=\textcolor{red}{\arabic*}]
      ...
      \item Cor meum conturbátum est,\textcolor{red}{~†} derelíquit me virtus \textbf{me}a:\textcolor{red}{~*} et lumen oculórum meórum, et ipsum \textit{non} \textit{est} \textbf{me}cum.
    ...
    \gabcsnippet{(c4) Vim(g') fa(h)ci(h')é(g)bant(gf~) (,) qui(g_[uh:l]h) quae(ji)ré(h_j)bant(i_[oh:h]h) á(g')ni(h)mam(h) me(g.)am.(g.) (::)}
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item In cápite libri scriptum est de me ut fácerem volun\textit{tá}\textit{tem} \textbf{tu}am:\textcolor{red}{~*} Deus meus, vólui, et legem tuam in médi\textit{o} \textit{cor}\textit{dis} \textbf{me}i.
    ...
    \item Tu autem, Dómine, ne longe fácias miseratiónes \textit{tu}\textit{as} \textbf{a} me:\textcolor{red}{~*} misericórdia tua et véritas tua sem\textit{per} \textit{su}\textit{sce}\textbf{pé}runt me.

    \item Quóniam circumdedérunt me mala, quorum \textit{non} \textit{est} \textbf{nú}merus:\textcolor{red}{~*} comprehendérunt me iniquitátes meæ, et non pótu\textit{i} \textit{ut} \textit{vi}\textbf{dé}rem.
    ...
    \item Exsúltent et læténtur super te om\textit{nes} \textit{quæ}\textbf{rén}tes te:\textcolor{red}{~*} et dicant semper: Magnificétur Dóminus: qui díligunt sa\textit{lu}\textit{tá}\textit{re} \textbf{tu}um.
  ...
  %  Répetition de l'Antienne
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c3) Con(e)fun(f)dán(h_i)tur(ii) (,) et(h') re(i)ve(j)re(ih)án(i.)tur,(i.) (;) qui(i) quæ(f')runt(i) á(h')ni(g)mam(f) me(f_e)am,(f'_) (,) ut(e) áu(d_e)fe(f')rant(h) e(f.)am.(f.) (::)}
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Quóniam aliéni insurrexérunt advérsum me,\textcolor{red}{~†} et fortes quæsiérunt á\textit{ni}\textit{mam} \textbf{me}am:\textcolor{red}{~*} et non proposuérunt Deum ante \textit{con}\textit{spéc}\textit{tum} \textbf{su}um.
  ...
  %  Répetition de l'Antienne
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c3) A(e)li(f)é(h_i)ni(i'_[oh:h]) (,) in(i)sur(h')re(i)xé(j)runt(ih~) in(i.) me,(i.) (;) et(i) for(f')tes(i) quæ(h')si(g)é(f_e)runt(f_e) (,) á(d_e)ni(f')mam(h) me(f.)am.(f.) (::)}
  ...
  \begin{center}
    ...
    \begin{minipage}{0.8\linewidth}
      \gresetinitiallines{0}
      \large
      \gabcsnippet{(c4)<c><v>\Vbar</v>.</c> In(h)sur(h)re(h)xé(h)runt(h) in(h) me(h) tés(i')tes(h) in(h)í(g.)qui.(g.) (::)(Z) <c><v>\Rbar</v>.</c> Et(h) men(h)tí(h)ta(h) est(h) in(h)i(i')quí(h)tas(h) sí(g.)bi.(g.) (::)}
      \bigskip
      \normalsize
      \begin{center}
