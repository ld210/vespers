...
\begin{document}
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Fílii hóminum, úsquequo gravi \textbf{cor}de?\textcolor{red}{~*}\\ \-\hspace{2cm} ut quid dilígitis vanitátem et quǽri\textit{tis} \textit{men}\textbf{dá}cium?

    \item Et scitóte quóniam mirificávit Dóminus sanctum \textbf{su}um:\textcolor{red}{~*}\\ \-\hspace{2cm} Dóminus exáudiet me cum clamáve\textit{ro} \textit{ad} \textbf{e}um.

    \item Irascímini, et nolíte peccáre:\textcolor{red}{~†} quæ dícitis in córdibus \textbf{ves}tris,\textcolor{red}{~*}\\ \-\hspace{2cm} in cubílibus vestris \textit{com}\textit{pun}\textbf{gí}mini.

    \item Sacrificáte sacrifícium justítiæ,\textcolor{red}{~†} et speráte in \textbf{Dó}mino.\textcolor{red}{~*}\\ \-\hspace{2cm} Multi dicunt: quis osténdit \textit{no}\textit{bis} \textbf{bo}na?

    \item Signátum est super nos lumen vultus tui, \textbf{Dó}mine:\textcolor{red}{~*}\\ \-\hspace{2cm} dedísti lætítiam in \textit{cor}\textit{de} \textbf{me}o.
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Nec fecit próximo \textit{su}\textit{o} \textbf{ma}lum,\textcolor{red}{~*}\\ \-\hspace{2cm} et oppróbrium non accépit advérsus \textit{pró}\textit{xi}\textit{mos} \textbf{su}os.

    \item Ad níhilum dedúctus est in conspéctu e\textit{jus} \textit{ma}\textbf{lí}gnus:\textcolor{red}{~*}\\ \-\hspace{2cm} timéntes autem Dó\textit{mi}\textit{num} \textit{glo}\textbf{rí}\textbf{fi}cat:

    \item Qui jurat próximo suo, \textit{et} \textit{non} \textbf{dé}cipit,\textcolor{red}{~*}\\ \-\hspace{2cm} qui pecúniam suam non dedit ad usúram, et múnera super innocén\textit{tem} \textit{non} \textit{ac}\textbf{cé}pit.
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Non congregábo conventícula eórum \textbf{de} san\textbf{guí}nibus,\textcolor{red}{~*}\\ \-\hspace{2cm} nec memor ero nóminum eórum per \textbf{lá}bia \textbf{me}a.

    \item Dóminus pars hereditátis meæ, et \textbf{cá}licis \textbf{me}i:\textcolor{red}{~*}\\ \-\hspace{2cm} tu es, qui restítues hereditátem \textbf{me}am \textbf{mi}hi.

    \item Funes cecidérunt mihi \textbf{in} præ\textbf{clá}ris:\textcolor{red}{~*} étenim heréditas mea præ\textbf{clá}ra est \textbf{mi}hi.

    \item Benedícam Dóminum, qui tríbuit mihi \textbf{in}tel\textbf{léc}tum:\textcolor{red}{~*}\\ \-\hspace{2cm} ínsuper et usque ad noctem increpuérunt me \textbf{re}nes \textbf{me}i.

    \item Providébam Dóminum in conspéctu \textbf{me}o \textbf{sem}per:\textcolor{red}{~*}\\ \-\hspace{2cm} quóniam a dextris est mihi, \textbf{ne} com\textbf{mó}vear.

    \item Propter hoc lætátum est cor meum, et exsultávit \textbf{lin}gua \textbf{me}a:\textcolor{red}{~*}\\ \-\hspace{2cm} ínsuper et caro mea requi\textbf{é}scet \textbf{in} spe.

    \item Quóniam non derelínques ánimam meam \textbf{in} in\textbf{fér}no:\textcolor{red}{~*}\\ \-\hspace{2cm} nec dabis sanctum tuum vidére cor\textbf{rup}ti\textbf{ó}nem.

    \item Notas mihi fecísti vias vitæ,\textcolor{red}{~†} adimplébis me lætítia cum \textbf{vul}tu \textbf{tu}o:\textcolor{red}{~*}\\ \-\hspace{2cm} delectatiónes in déxtera tua \textbf{us}que in \textbf{fi}nem.
  \end{enumerate}
  %  Répetition de l'Antienne
  \grecommentary{\textit{Reprise de l'Antienne.}}
