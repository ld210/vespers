...
\begin{document}
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Quia delectásti me, Dómine, in fac\textit{tú}\textit{ra} \textbf{tu}a:\textcolor{red}{~*}\\ \-\hspace{2cm} et in opéribus mánuum tuá\textit{rum} \textit{ex}\textit{sul}\textbf{tá}bo.
    ...
    \item Cum exórti fúerint peccatóres \textit{sic}\textit{ut} \textbf{fe}num:\textcolor{red}{~*}\\ \-\hspace{2cm} et apparúerint omnes, qui operántur \textit{in}\textit{i}\textit{qui}\textbf{tá}tem.
    ...
    \item Quóniam ecce inimíci tui, Dómine,\textcolor{red}{~†} quóniam ecce inimíci tu\textit{i} \textit{per}\textbf{í}bunt:\textcolor{red}{~*}\\ \-\hspace{2cm} et dispergéntur omnes, qui operántur \textit{in}\textit{i}\textit{qui}\textbf{tá}tem.

    \item Et exaltábitur sicut unicórnis \textit{cor}\textit{nu} \textbf{me}um:\textcolor{red}{~*}\\ \-\hspace{2cm} et senéctus mea in miseri\textit{cór}\textit{di}\textit{a} \textbf{ú}beri.

    \item Et despéxit óculus meus ini\textit{mí}\textit{cos} \textbf{me}os:\textcolor{red}{~*}\\ \-\hspace{2cm} et in insurgéntibus in me malignántibus áudi\textit{et} \textit{au}\textit{ris} \textbf{me}a.
