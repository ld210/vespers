...
\begin{document}
  ...
  \gabcsnippet{(c4) A(g)sti(g)té(g)runt(g') () re(g)ges(g') ter(ixi)rae,(gg) (,) et(f) prín(g')ci(h)pes(g'_[oh:h]) con(g)ve(f')né(g)runt(h') in(ixi) u(h)num,(f.) (;) ad(h)vér(f')sus(h) Dó(j')mi(j)num,(i_[oh:h]g_[oh:h]) (,) et(i') ad(j)vér(h)sus(gf) Chri(gh)stum(h) e(g.)jus.(g.) (::)}
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Quóniam tu es, qui extraxísti me de \textbf{ven}tre:\textcolor{red}{~*} spes mea ab ubéribus matris meæ. In te projéctus \textit{sum} \textit{ex} \textbf{ú}tero.
    ...
    \item Aruit tamquam testa virtus mea,\textcolor{red}{~†} et lingua mea adhǽsit fáucibus \textbf{me}is:\textcolor{red}{~*} et in púlverem mortis \textit{de}\textit{du}\textbf{xís}ti me.
    ...
    \item Ipsi vero consideravérunt et inspe\textbf{xé}runt me:\textcolor{red}{~*} divisérunt sibi vestiménta mea, et super vestem meam mi\textit{sé}\textit{runt} \textbf{sor}tem.
    ...
    \item Edent páuperes, et saturabúntur:\textcolor{red}{~†} et laudábunt Dóminum qui requírunt \textbf{e}um:\textcolor{red}{~*} vivent corda eórum in sǽ\textit{cu}\textit{lum} \textbf{sǽ}culi.
    ...
    \item Manducavérunt et adoravérunt omnes pingues \textbf{ter}ræ:\textcolor{red}{~*} in conspéctu ejus cadent omnes qui descén\textit{dunt} \textit{in} \textbf{ter}ram.

    \item Et ánima mea illi \textbf{vi}vet:\textcolor{red}{~*} et semen meum sér\textit{vi}\textit{et} \textbf{ip}si.

    \item Annuntiábitur Dómino generátio ventúra :\textcolor{red}{~†}\\ et annuntiábunt cæli justítiam ejus pópulo qui na\textbf{scé}tur,\textcolor{red}{~*} quem \textit{fe}\textit{cit} \textbf{Dó}minus.
  \end{enumerate}
  %  Répetition de l'Antienne
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) Di(g)vi(g')sé(h)runt(h') si(g)bi(g'_[oh:h]) (,) ve(i)sti(h')mén(j)ta(i') me(h)a,(h.) (;) et(h) su(j')per(i) ve(jk)stem(h) me(h_g)am(g.) (,) mi(g_[oh:h]f)sé(gh)runt(h) sor(g.)tem.(g.) (::)}
  ...
  %  Répetition de l'Antienne
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) In(g)sur(g)re(g')xé(h)runt(h') in(g) me(g'_[oh:h]) (,) te(i)stes(j') in(j)í(j_i)qui,(h.) (;) et(j_k) men(i_[uh:l]j)tí(h')ta(h) est(g'_[oh:h]) (,) in(g)í(e_[uh:l]f)qui(gh)tas(h) si(g.)bi.(g.) (::)}
  ...
  \begin{multicols}{2}
    \begin{footnotesize}
      \begin{enumerate}[label=\textcolor{red}{\emph{\arabic*}}]
        ...
        \item \textit{Espère au Seigneur ! Aie courage et que ton cœur soit ferme ! Espère au Seigneur.}
      \end{enumerate}
    \end{footnotesize}
  \end{multicols}
