...
\begin{document}
  ...
  \begin{titlepage}\centering
    ...
    \begin{Large}
      \textit{
        Depuis le 2\textsuperscript{ème} Dimanche après l'Épiphanie,\\ au Dimanche de la Quinquagesime inclusivement.\\
      }
    \end{Large}
    \medskip
    \large et\\
  ...
  \begin{center}
    ...
    \emph{
      ...
      (Louanges à Vous, Seigneur d'éternelle gloire.)
    }
  }
  \end{center}
  ...
  \end{enumerate}
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) De(d)fi(d)ci(dc)én(f)te(g) vi(f_h)no,(h'_) (,) jus(h)sit(h) Je(hj)sus(h') im(g)plé(h')ri(g) hý(e_f)dri(g)as(fe) a(d)qua,(d.) (;) quae(h!iw!jv_IH') in(g) vi(fe)num(g) con(fe~)vér(d)sa(fe) est,(c) al(d)le(fe)lú(d.)ia.(d.) (::)}
  \smallskip
  ...
  \normalsize
  \gresetinitiallines{0}
  \gregorioscore{magnificat/magnificat-1G2}
  ...
  \end{enumerate}
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) Do(f)mi(gh)ne,(h.) *(,) si(g') tu(ixi) vis,(g_hG'_E_) (,) po(f)tes(g) me(e) mun(fe~)dá(d.)re:(d.) (:) et(d) a(f_/f_)it(d!ew!fv_EC') Je(f)sus:(ixghg/hih.) (;) Vo(h)lo,(gv_FE) (,) mun(fgf~)dá(d.)re.(d.) (::)}
  \bigskip
  ...
  \end{enumerate}
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) Do(f)mi(gh)ne,(h'_) (,) sal(f)va(gh) nos,(h) pe(gf)rí(g_f)mus;(d.) (;) ím(d)pe(g)ra,(f.) (,) et(ef) fac(de) De(c)us(d) tran(e_f)quil(g)li(fe)tá(d.)tem.(d.) (::)}
  \bigskip
  ...
  \end{enumerate}
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) Col(cd)lí(ixdh'!iv)gi(h')te(h) (,) pri(hj)mum(h) zi(h)zá(h)ni(h)a,(ixhg/hiHG'g) (;) et(g) al(f)li(g)gá(h')te(g) e(fg)a(f'_) (,) in(f) fa(f)scí(fg)cu(f)los(e') ad(f) com(g)bu(fe)rén(d.)dum :(d.) (:) trí(f)ti(fe)cum(de) au(d)tem(c) con(c)gre(d)gá(ffg)te(f'_) (,) in(f) hór(fhg'h)re(e)um(fg~) me(g_[oh:h])um,(c'_[oh:h]) (,) di(d)cit(fe) Dó(d)mi(d)nus.(d.) (::)}
  \smallskip
  ...
  \normalsize
  \gresetinitiallines{0}
  \gregorioscore{magnificat/magnificat-1A2}
  ...
  \end{enumerate}
  \grecommentary{\textit{Reprise de l'Antienne.}}
  \gabcsnippet{(c4) Si(ixdh'!iv)mi(h)le(h) est(h') () re(g)gnum(h) cae(ji)ló(h)rum(h'_) (;) fer(h)mén(h)to,(g) quod(f) ac(e)cép(f')tum(g) mú(h')li(g)er(h'_) (,) ab(h)scón(g')dit(e) in(fg~) fa(f)rí(fe)nae(dc) sa(d)tis(f) tri(fg)bus,(f.) (;) do(f)nec(gh) fer(h)me(g)tá(e_f)tum(g) est(fe) to(d.)tum.(d.) (::)}
  \bigskip
  ...
  \begin{center}
    \vspace*{\fill}
    \LARGE Salut du Très Saint Sacrement.
    \vspace*{\fill}
  \end{center}

  \newpage
  \subfile{salut-saint-sacrement.tex}
\end{document}