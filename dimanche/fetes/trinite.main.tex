...
\begin{document}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{../epiphanie-septuagesime-careme/o-salutaris.jpg}
  \end{figure}
  ...
  \gresetinitiallines{1}
  \greillumination{\initfamily\fontsize{11mm}{11mm}\selectfont T}
  \gregorioscore{../epiphanie-septuagesime-careme/hy--tantum_ergo--solesmes}
