...
\begin{document}
  ...
  \begin{enumerate}[label=\textcolor{red}{\emph{\arabic*}}]
    ...
    \item Memóriam fecit mirabílium suórum,\textcolor{red}{~†} miséricors et mise\textbf{rá}tor \textbf{Dó}\textbf{mi}nus:\textcolor{red}{~*}\\ escam dedit timén\textit{ti}\textbf{bus} se.
    ...
    \item Fidélia ómnia mandáta ejus:\textcolor{red}{~†} confirmáta in \textbf{sǽ}culum \textbf{sǽ}\textbf{cu}li,\textcolor{red}{~*}\\ facta in veritáte et æ\textit{qui}\textbf{tá}te.
    ...
    \item Intelléctus bonus ómnibus faci\textbf{én}tibus \textbf{e}um:\textcolor{red}{~*}\\ laudátio ejus manet in sǽcu\textit{lum} \textbf{sǽ}culi.
  ...
  \begin{enumerate}[label=\textcolor{red}{\emph{\arabic*}}]
    ...
    \item Parátum cor ejus speráre in Dómino,\textcolor{red}{~†} confirmátum \textit{est} \textit{cor} \textbf{e}jus:\textcolor{red}{~*} \\ non commovébitur donec despíciat inimícos \textbf{su}os.

    \item Dispérsit, dedit paupéribus:\textcolor{red}{~†} justítia ejus manet in sǽ\textit{cu}\textit{lum} \textbf{sǽ}culi,\textcolor{red}{~*} \\ cornu ejus exaltábitur in \textbf{gló}ria.

    \item Peccátor vidébit, et irascétur,\textcolor{red}{~†} déntibus suis fremet \textit{et} \textit{ta}\textbf{bé}scet:\textcolor{red}{~*} \\ desidérium peccatórum per\textbf{í}bit.
  ...
  \begin{enumerate}[label=\textcolor{red}{\arabic*}]
    ...
    \item Super misericórdia tua, et ve\textit{ri}\textit{tá}\textit{te} \textbf{tu}a:\textcolor{red}{~*} \\ nequándo dicant gentes: Ubi est Deus \textit{e}\textbf{ó}rum?
    ...
    \item Manus habent, et non palpábunt:\textcolor{red}{~†} pedes habent, et \textit{non} \textit{am}\textit{bu}\textbf{lá}bunt:\textcolor{red}{~*} \\ non clamábunt in gúttu\textit{re} \textbf{su}o.
    ...
    \item Qui timent Dóminum, spera\textit{vé}\textit{runt} \textit{in} \textbf{Dó}mino:\textcolor{red}{~*} \\ adjútor eórum et protéctor \textit{e}\textbf{ó}rum est.
  \end{enumerate}
