...
\begin{document}
  ...
  %   \item Domus Israël sperá\textit{vit} \textit{in} \textbf{Dó}mino:~* adjútor eórum et pro\textit{téc}\textit{tor} \textit{e}\textbf{ó}\textbf{rum} est,
  ...
  %   \begin{center}
  %     \footnotesize{\textit{
  %       A partir du 17 décembre, on prends l'antienne "O" correspondante. Voir page...
  %     }}
  %   \end{center}
  % \end{center}
  ...
  \begin{center}
    ...
    \begin{center}
      \footnotesize{\textit{
        Prendre une des antiennes "O" page ...
      }}
    \end{center}
  \end{center}
  ...
  \begin{center}
    \textcolor{red}{\large{Salut du Saint Sacrement page ...}}
  \end{center}
  ...
  \begin{center}
    \footnotesize{
      \textit{
        O Orient (Zacharie VI, 12), splendeur de la lumière éternelle (Hébreux I, 3), et soleil de justice (Malachie IV, 2) : venez et éclairez ceux qui sont assis dans les ténèbres et dans l’ombre de la mort (Isaïe IX, 2 & Luc I, 78-79). 
      }
    }
  \end{center}
  \medskip
  ...
  \begin{center}
    \footnotesize{
      \textit{
        O Emmanuel (Isaïe VII, 14 & VIII, 8), * notre Roi et notre Législateur (Isaïe XXXIII, 22), Attente des Nations (Genèse XLIX, 10) et leur Sauveur : venez nous sauver, Seigneur notre Dieu.  
      }
    }
  \end{center}
  \medskip
