...
\begin{document}
  ...
  \begin{titlepage}\centering
    ...
    \begin{normalsize}
      \textit{
        du Temps Pascal\\
        Depuis le Dimanche de Pâques au Dimanche de Pentecôte\\
      }
    \end{normalsize}
    \medskip
    \large et\\
  ...
  \gregorioscore{../ordinaires/antiennes-mariales/an--ave_regina_caelorum_(simple_tone)--solesmes}
  \medskip
  \begin{footnotesize}
    \textit{
  ...
  \gregorioscore{../ordinaires/ps--laudate_dominum_omnes_gentes_(psalmus_116)--solesmes}
  \bigskip
  \begin{footnotesize}
    \textit{
